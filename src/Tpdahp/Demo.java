	...
	public static void main(String[] args) {
		...
		{ 
			...
			else
			{
				...
				DoubleDiffusionConverter doubleDiffusion = new DoubleDiffusionConverter(diffusionData);
				
				doubleDiffusion.ComputeDiffusion();
				doubleDiffusion.DisplayDiffusionData();
			}
		}
	}
