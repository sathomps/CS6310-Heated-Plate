...
public class FloatPlate extends Plate {
	private float[][] _plateTemperatureDataArray;
	
	// Parameterized Constructor
	public FloatPlate(DiffusionData diffusionData)
	{
		_diffusionData = diffusionData;
		_plateDimension = diffusionData.getLinearDimension();
		_plateTemperatureDataArray = 
				new float [_plateDimension + 2] [_plateDimension + 2];
		
		InitializePlateTemperature();
	}
	
	// Get method for plate temperature data array
	public float [][] getPlateTemperatureDataArray()
	{
